...
@section('alert')
    ...
    <div id="toast-container" class="toast-top-right">
        <div class="toast toast-success" aria-live="polite" style="" id="alert-success">
    ...
    <div id="toast-container" class="toast-top-right">
        <div class="toast toast-success" aria-live="polite" style="">
            <div class="toast-title">{{Session::get('alert-fail')}}</div>
            <div class="toast-message">Terimakasih</div>
        </div>
    </div>
    @endif
            ...
            <div class="page-title-heading">
                ...
                <div>Data Lainnya
                    <div class="page-title-subheading">
                        semua data pendukung akan ditampilkan di page ini
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="main-card mb-3 card">
                ...
                <div class="card-body">
                    <div class="col">
                        ...
                        <button class="btn btn-info" data-toggle="modal" data-target="#modalAddRole">
                            TAMBAH ROLE
                        </button>
                        <button class="btn btn-warning" data-toggle="modal" data-target="#modalAddStatus">
                            TAMBAH STATUS
                        </button>
                    </div>
                </div>
                ...
                <div class="table-responsive" style="padding : 1%">
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="petugas">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td class="text-center text-muted">{{$k->id_kategori}}</td>
                                <td>
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            ...
                                            <div class="widget-content-left flex2">
                                                <div class="widget-heading">{{$k->nama}}</div>
                                            </div>
                                        </div>
                                    </div>
                                </td>
...
@section('modal')
<div class="modal fade" id="modalAddKategori" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('add-kategori')}}" method="POST">
                ...
                <div class="modal-body">
                    <div class="poistion-relative form-group">
...
<div class="modal fade" id="modalAddRole" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
    aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="modalAddStatus" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
    aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
